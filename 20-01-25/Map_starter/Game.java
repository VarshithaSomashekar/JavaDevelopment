...
public class Game {
    ...
    public void begin(Team home, Team away) {
        ...
        System.out.println
        (
        "\n - This matchup takes place at the " + this.arena + " arena on " + date.getDayOfMonth()+"/" + date.getMonthValue()+ "/" + date.getYear() + ".  " + this.date.format(DateTimeFormatter.ofPattern("dd/MM/yyyy"))+
